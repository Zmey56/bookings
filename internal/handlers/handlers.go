...
import (
	...
	"github.com/zmey56/bookings/internal/driver"
	"github.com/zmey56/bookings/internal/forms"
	"github.com/zmey56/bookings/internal/helpers"
	"github.com/zmey56/bookings/internal/models"
	"github.com/zmey56/bookings/internal/render"
	"github.com/zmey56/bookings/internal/repository"
	"github.com/zmey56/bookings/internal/repository/dbrepo"
	"log"
	"net/http"
	"strconv"
	"strings"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	//send notification - first to geust
	htmlMessage := fmt.Sprintf(`
<strong>Reservation Confermation</strong><br>
Dear %s, <br>
This is confirmation your reservation from %s to %s.
	...
	for _, x := range rooms {
		...
		for name, value := range curMap {
			if val, ok := curMap[name]; ok {
				if val > 0 {
					if !form.Has(fmt.Sprintf("block_map_%d_%s", x.ID, name)) {
